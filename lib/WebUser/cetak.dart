...
class Cetak extends StatefulWidget {
  ...
  final String nip;
  const Cetak({super.key, required this.nip, required this.data});
            ...
            switch (settings.name) {
              case '/':
                return MaterialPageRoute(
                  builder: (context) => Cetak(nip: widget.nip, data: widget.data,),
                );
              default:
                return null;
            }
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => Cetak(data: widget.data,nip: widget.nip)),
                );
              },
