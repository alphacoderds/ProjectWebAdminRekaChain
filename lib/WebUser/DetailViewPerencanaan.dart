  ...
  void fetchData() async {
    try {
      final response = await http.get(
        Uri.parse(
            'https://192.168.10.102/ProjectWebAdminRekaChain/lib/Project/edit_perencanaan.php?nama=${widget.selectedProject['nama']}&kodeLot=${widget.selectedProject['kodeLot']}'),
      );
