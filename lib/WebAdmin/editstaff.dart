  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://192.168.1.4/ProjectWebAdminRekaChain/lib/Project/edit_tambahstaff.php?kode_staff=${widget.selectedStaff['kode_staff']}&nip=${widget.selectedStaff['nip']}'),
      );
  ...
  void _updateDataAndNavigateToListStaff() async {
    try {
      final response = await http.post(
        Uri.parse(
            'http://192.168.1.4/ProjectWebAdminRekaChain/lib/Project/edit_tambahstaff.php'),
        body: {
