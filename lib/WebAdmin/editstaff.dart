  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
        Uri.parse(
            'https://rekachain.000webhostapp.com/Project/edit_tambahstaff.php?kode_staff=${widget.selectedStaff['kode_staff']}&nip=${widget.selectedStaff['nip']}'),
      );
  ...
  void _updateDataAndNavigateToListStaff() async {
    try {
      final response = await http.post(
        Uri.parse(
            'https://rekachain.000webhostapp.com/Project/edit_tambahstaff.php'),
        body: {
