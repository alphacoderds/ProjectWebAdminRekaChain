...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<bool> validateLogin(String nip, String password) async {
    final response = await http.post(
      Uri.parse(
          'http://192.168.10.230/ProjectWebAdminRekaChain/lib/Project/validate_login.php'),
      body: {
        'nip': nip,
  ...
  Future<String?> getUserRole(String nip) async {
    final response = await http.post(
      Uri.parse(
          'http://192.168.10.230/ProjectWebAdminRekaChain/lib/Project/test.php'),
      body: {
        'nip': nip,
      },
    );
...
//batas
  Future loginbtn() async {
    ...
    var response = await http.post(
        Uri.parse(
            'http://192.168.10.230/ProjectWebAdminRekaChain/lib/Project/create_login.php'),
