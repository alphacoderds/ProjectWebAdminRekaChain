  ...
  void fetchData() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://192.168.8.207/ProjectWebAdminRekaChain/lib/Project/edit.php?id_project=${widget.selectedProject['id_project']}&kodeLot=${widget.selectedProject['kodeLot']}'),
      );
  ...
  void _updateDataAndNavigateToListProject() async {
    try {
      final response = await http.post(
        Uri.parse(
            'http://192.168.8.207/ProjectWebAdminRekaChain/lib/Project/edit.php'),
        body: {
