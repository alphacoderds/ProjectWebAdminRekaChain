  ...
  void fetchData() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://192.168.8.153/ProjectWebAdminRekaChain/lib/Project/edit_tambahproject.php?kodeProject=${widget.selectedProject['kodeProject']}&namaProject=${widget.selectedProject['namaProject']}'),
      );
  ...
  void _updateDataAndNavigateToListProject() async {
    try {
      final response = await http.post(
        Uri.parse(
            'http://192.168.8.153/ProjectWebAdminRekaChain/lib/Project/edit_tambahproject.php'),
        body: {
          'no_tambahproject':
